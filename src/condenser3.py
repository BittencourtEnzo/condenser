...
def summarize3(sentences):
    tokenizer = T5Tokenizer.from_pretrained('t5-base')
    model = T5ForConditionalGeneration.from_pretrained('t5-base')

    def summarize_text(sentences, model, tokenizer, max_length=2048, num_beams=5):
        # Preprocess the text
    ...
    summary = summarize_text(sentences, model, tokenizer)
    return summary